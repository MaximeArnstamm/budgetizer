...
public class SpringConcordionJUnitRunner extends SpringJUnit4ClassRunner {
	private final Description fixtureDescription;
	private final FrameworkMethod fakeMethod;

	public SpringConcordionJUnitRunner(Class<?> fixtureClass) throws InitializationError, NoSuchMethodException {
		super(fixtureClass);
